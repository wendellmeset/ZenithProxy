    ...
    static {
        final PacketHandlerCodec CLIENT_CODEC = PacketHandlerCodec.builder()
            ...
            .state(ProtocolState.CONFIGURATION, PacketHandlerStateCodec.<ClientSession>builder()
                ...
                .registerInbound(ClientboundResourcePackPushPacket.class, ResourcePackPushHandler.INSTANCE)
                .registerInbound(ClientboundResourcePackPopPacket.class, ResourcePackPopHandler.INSTANCE)
            ...
            .state(ProtocolState.GAME, PacketHandlerStateCodec.<ClientSession>builder()
                ...
                .registerInbound(ClientboundPlayerRotationPacket.class, new PlayerRotationHandler())
                .registerInbound(ClientboundPongResponsePacket.class, PongResponseHandler.INSTANCE)
                .registerInbound(ClientboundResourcePackPushPacket.class, ResourcePackPushHandler.INSTANCE)
                .registerInbound(ClientboundResourcePackPopPacket.class, ResourcePackPopHandler.INSTANCE)
                ...
                .registerInbound(ClientboundSetPlayerInventoryPacket.class, new SetPlayerInventoryHandler())
                .registerInbound(ClientboundSetCursorItemPacket.class, new SetCursorItemHandler())
                ...
                .registerInbound(ClientboundRecipeBookAddPacket.class, new RecipeBookAddHandler())
                .registerInbound(ClientboundRecipeBookRemovePacket.class, new RecipeBookRemoveHandler())
                .registerInbound(ClientboundRecipeBookSettingsPacket.class, new RecipeBookSettingsHandler())
                .registerInbound(ClientboundUpdateRecipesPacket.class, new UpdateRecipesHandler())
                .registerInbound(ClientboundUpdateTagsPacket.class, UpdateTagsHandler.INSTANCE)
                ...
                .registerInbound(ClientboundEntityPositionSyncPacket.class, new EntityPositionSyncHandler())
        ...
        final PacketHandlerCodec SERVER_SHARED_CODEC = PacketHandlerCodec.builder()
            ...
            .state(ProtocolState.CONFIGURATION, PacketHandlerStateCodec.<ServerSession>builder()
                ...
                .registerPostOutbound(ClientboundFinishConfigurationPacket.class, new ClientFinishConfigurationPostOutgoingHandler())
                .build())
            ...
            .state(ProtocolState.GAME, PacketHandlerStateCodec.<ServerSession>builder()
                ...
                .registerOutbound(ClientboundKeepAlivePacket.class, KeepAliveOutgoingHandler.INSTANCE)
                .registerPostOutbound(ClientboundStartConfigurationPacket.class, new ClientStartConfigurationPostOutgoingHandler())
                .registerPostOutbound(ClientboundTransferPacket.class, new TransferPostOutgoingHandler())
                .build())
            .build();
